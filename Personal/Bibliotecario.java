...
public class Bibliotecario extends Cliente{
    ...
    public void eliminarPrestamo(Usuario usuario){
    ...
    public void realizarPrestamo(Usuario usuario,ArrayList<Libro> general){
        ...
        if(existe){
            ...
            System.out.println("El id ingresado no esta registrado en el sistema");
        }
    }
    
    public void devolverPrestamo(Usuario usuario,ArrayList<Libro> general){
    ...
    public void renovarPrestamo(Usuario usuario){
        ...
        if(--index>usuario.getPrestamos().size() || index<0){
            System.out.println("Renovacion no valida");
            return;
        }
