...
public class Usuario extends Cliente {
    ...
    public Usuario(String contra,String nombre, String apellido, int edad) {
    ...
    public String toString() {
        return "Usuario{" + "contra=" + contra + ", dinero=" + dinero + ", prestamos=" + prestamos + ", portapeles=" + portapeles + '}';
    }
